...
# Web Automation
        ...
        for line in csv_reader:
            ...
            driver = webdriver.Chrome()
            driver.get('https://www.sitepromotiondirectory.com/submit.php')
            driver.maximize_window()
            time.sleep(5)

            freelink = driver.find_element("xpath", '/html/body/div[4]/div[2]/form/table/tbody/tr[1]/td/table/tbody/tr[2]/td[1]/input')
            freelink.click()
            time.sleep(5)

            Title_field = driver.find_element("xpath", '/html/body/div[4]/div[2]/form/table/tbody/tr[3]/td[2]/input')
            Title_field.send_keys(line[3])
            time.sleep(3)
        
            URL_field = driver.find_element("xpath", '/html/body/div[4]/div[2]/form/table/tbody/tr[4]/td[2]/input')
            URL_field.send_keys(line[2])
            time.sleep(3)


            Description_field = driver.find_element("xpath", '/html/body/div[4]/div[2]/form/table/tbody/tr[6]/td/textarea')
            Description_field.send_keys(line[4])
            time.sleep(3)

            username_field = driver.find_element("xpath", '/html/body/div[4]/div[2]/form/table/tbody/tr[9]/td[2]/input')
            username_field.send_keys(line[0])
            time.sleep(3)

            Email_field = driver.find_element("xpath", '/html/body/div[4]/div[2]/form/table/tbody/tr[10]/td[2]/input')
            ...
            submit = driver.find_elements(By.XPATH, '/html/body/div[4]/div[2]/form/table/tbody/tr[15]/td/input')
            submit[0].click()
